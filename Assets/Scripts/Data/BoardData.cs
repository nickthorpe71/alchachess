    ...
    public class Board
    {
        ...
        public Board()
        {
            ...
            tiles[0] = new Tile[] {
                ...
                new Tile(4, 0, PieceLabel.Elder, PieceColor.Black, PlayerToken.P1),
                new Tile(5, 0, PieceLabel.DarkOne, PieceColor.Black, PlayerToken.P1),
                new Tile(6, 0, PieceLabel.AbyssLord, PieceColor.Black, PlayerToken.P1),
                new Tile(7, 0, PieceLabel.Iron, PieceColor.Black, PlayerToken.P1),
                new Tile(8, 0)
                };
            tiles[1] = new Tile[] {
                new Tile(0, 1 ),
            ...
            tiles[7] = new Tile[] {
                ...
                new Tile(4, 7, PieceLabel.Elder, PieceColor.White, PlayerToken.P2),
                new Tile(5, 7,PieceLabel.AngelOfEden, PieceColor.White, PlayerToken.P2),
                new Tile(6, 7,PieceLabel.PhoenixKnight, PieceColor.White, PlayerToken.P2),
                new Tile(7, 7,PieceLabel.Esa, PieceColor.White, PlayerToken.P2),
                new Tile(8, 7 )
                };
        }
    }
